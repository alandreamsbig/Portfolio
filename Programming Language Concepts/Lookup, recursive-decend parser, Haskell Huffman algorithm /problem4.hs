-- Alan Tsai
-- CS360 HW2 Problem 4
-- References:https://github.com/WeaponsPrime/Huffman/blob/master/Huffman.hs
-- https://github.com/vbevans94/huffman-haskell/blob/master/Huffman.hs
...
main =
  do 
    let result = "makeTreeList: " ++ (show testMakeTreeList) ++ "\n" ++
